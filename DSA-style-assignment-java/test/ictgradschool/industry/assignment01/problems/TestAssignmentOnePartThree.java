...
public class TestAssignmentOnePartThree {
    ...
    @Test
    public void testFindOccurrenceOfCharacters() {
        assertArrayEquals(new int[]{1, 2, 6}, assignmentOnePartThree.findOccurrenceOfCharacters("Good morning", 'o')); // Standard
        assertArrayEquals(null, assignmentOnePartThree.findOccurrenceOfCharacters("Hello World", 'a')); // No occurrence
        assertArrayEquals(new int[]{0, 8}, assignmentOnePartThree.findOccurrenceOfCharacters("Jumping jellyfish!", 'J')); // Case
        assertArrayEquals(new int[]{8, 80}, assignmentOnePartThree.findOccurrenceOfCharacters("Taumata whakatangi hangakoa" +
                "uau o tamatea turi pukakapiki maunga horo nuku pokai whenua kitanatahu", 'w'));
        assertNull(assignmentOnePartThree.findOccurrenceOfCharacters("", 'z')); // Tricky!
    }
    ...
    public void testComputeFibonacci() {
        ...
        assertNull(assignmentOnePartThree.computeFibonacci(0));
